    ...
    for(var d in dates){
        ...
        $('#dates-area').prepend(`
            <div class="date" id="date${d}">
                ...
                <span class="details">
                    <label>Checkin</label>
                    <input type="datetime-local" id="checkin" value="${checkinInput}">
                    <label>Checkout</label>
                    <input type="datetime-local" id="checkout" value="${checkoutInput}">
                    <!-- <h5>Ticket</h5> -->
                    <span class="ticket">
                    ...
                    if(itemDone == false){
                        $('#reminder-list #ourPendingItens').append(
                            `<span class="item">
                                ...
                                <textarea rows="1" class="input" id="list-item-${itemID}" onkeypress="return checkKeypress(event)" onfocusout="updateItem('${lastDateID}', '${itemID}', 'shared')" value="${itemName}" contenteditable>${itemName}</textarea>
                            </span>`
                        );
                    }
                    else{
                    ...
                    if(itemDone == false){
                        $('#reminder-list #myPendingItens').append(
                            `<span class="item">
                                ...
                                <textarea rows="1" class="input" id="list-item-${itemID}" onkeypress="return checkKeypress(event)" onfocusout="updateItem('${lastDateID}', '${itemID}', '${firebase.auth().currentUser.uid}')" value="${itemName}" contenteditable>${itemName}</textarea>
                            </span>`
                        );
                    }
                    else{
